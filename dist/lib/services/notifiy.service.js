        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!deviceIdPhoneMap[deviceId]) {
                    const device = (yield device_schema_1.Device.findById(deviceId).select("userId").lean());
                    const userData = (yield user_schema_1.User.findById(device.userId).select("phone email userName").lean());
    ...
    planExpired(userId, userPlanId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userData = (yield user_schema_1.User.findById(userId).select("phone email userName").lean());
...
//# sourceMappingURL=notifiy.service.js.map