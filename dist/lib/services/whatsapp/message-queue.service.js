...
class MessageQueueService {
    ...
    getPendingMessagesToContacts(limit = 10) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger_1.default.info(logFileName, `FOUND ${pendingMessagesToContacts.length} PENDING MESSAGES TO CONTACT`);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (let i = 0; i < errorMessages.length; i++) {
                    ...
                    logger_1.default.info(logFileName, `Sending failed message ${message._id}`);
                    try {
    ...
    updateMessagePriority(messageId, priority) {
        return __awaiter(this, void 0, void 0, function* () {
            yield message_schema_1.MessageQueue.findByIdAndUpdate(messageId, { $inc: { priority: -1 } });
        });
    }
}
