...
export declare class TransactionModel {
    ...
    createTransactionForWallet(walletId: string, userId: string, type: ETransactionTypes, amount: number, description: string, metaData?: Record<string, any>): Promise<ITransactionModel>;
