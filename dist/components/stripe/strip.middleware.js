...
exports.validateStripeEvent = void 0;
...
exports.validateStripeEvent = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log("secret is", index_1.stripeConfig.webhookSecretKey);
    try {
        const event = yield stripe_model_1.default.validateSignature(req.body, sig, index_1.stripeConfig.webhookSecretKey);
        req.body = event;
        next();
    }
    catch (err) {
