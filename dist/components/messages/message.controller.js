    ...
    constructor() {
        this.queueTextMessage = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                responseHandler.reqRes(req, res).onFetch("ADDED_TO_QUEUE_TEXT", yield message_model_1.default.addMessageToQueue(req.userId, req.body, req.deviceId)).send();
            }
            catch (e) {
        ...
        this.queueListMessage = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                responseHandler.reqRes(req, res).onFetch("ADDED_TO_QUEUE_LIST", yield message_model_1.default.addMessageToQueue(req.userId, req.body, req.deviceId)).send();
            }
            catch (e) {
                // send error with next function.
                next(responseHandler.sendError(e));
        ...
        this.queueBtnMessage = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                responseHandler.reqRes(req, res).onFetch("ADDED_TO_QUEUE_BUTTOn", yield message_model_1.default.addMessageToQueue(req.userId, req.body, req.deviceId)).send();
            }
            catch (e) {
                // send error with next function.
                next(responseHandler.sendError(e));
