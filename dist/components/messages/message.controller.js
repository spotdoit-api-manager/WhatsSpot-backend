...
class MessageController {
    constructor() {
        ...
        this.fastList = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                // req.body.messageType = EWhatsappMessageTypes.LIST_MESSAGE;    
                responseHandler.reqRes(req, res).onFetch("MESSAGE_SENT", yield message_model_1.default.sendFastMessage(req.userId, req.body.numbers, req.body.message, "LIST_MESSAGE", req.deviceId, req.walletId)).send();
            }
            catch (e) {
                // send error with next function.
                next(responseHandler.sendError(e));
