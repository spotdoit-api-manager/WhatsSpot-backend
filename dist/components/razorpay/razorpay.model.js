    ...
    createOrder(userId, walletId, planId, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const transaction = yield transaction_model_1.default.createTransactionForRazorPay(plan.planId, order.order.id, userId, walletId, transaction_interface_1.ETransactionTypes.CREDIT, amount, transactionMessage);
                if (!transaction)
                    throw new Error("UNKNOWN_ERROR");
