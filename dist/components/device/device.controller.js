    ...
    constructor() {
        ...
        this.sendTextMessage = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                responseHandler.reqRes(req, res).onFetch("MESSAGE_SENT", yield message_model_1.default.sendMessage(req.userId, req.body.to, req.body.message, whatsapp_enum_1.EWhatsappMessageTypes.TEXT_MESSAGE, req.params.deviceId, req.walletId)).send();
            }
            catch (e) {
