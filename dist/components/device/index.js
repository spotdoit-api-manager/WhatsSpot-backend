...
exports.default = [
    ...
    },
    {
        ...
        method: "post",
        escapeAuth: false,
        handler: [message_middleware_1.validateAnyMessage, device_controller_1.default.addMessageToQueue]
    },
    {
    ...
    },
    {
        ...
        method: "post",
        escapeAuth: false,
        handler: [message_middleware_1.validateAnyMessage, device_controller_1.default.sendTextMessage]
    },
    {
