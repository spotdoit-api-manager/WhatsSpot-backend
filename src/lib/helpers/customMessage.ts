...
export const award = {
  ...
  AWARD_LIST:"Hurray , awards of the show fetch",
  SHOW_LIST:"Hurray ,shows fetched",
  AUDIENCE_COMMENTS:"Hurray,Audience Comments fetched ",
  JURY_COMMENTS:"Hurray,Jury Comments fetched ",
  NOMINEES_LIST:"Hurray,List Of Nominees fetched ",
  CREATED_SHOW:"Hurray , New show created"
};
...
export const ques = {
  CREATED: "Hurray! new question has been added successfully",
  CREATED_DEC: "This question has been created with the some scenario so adding some description.",
  FETCH_ALL: "Hurray,Here is your all ques.",
  UPDATED: "Hurray! Your question has been successfully updated",
};

export const quiz = {
  CREATED: "Hurray! new quiz has been added successfully",
  CREATED_DEC: "This question has been created with the some scenario so adding some description.",
  FETCH_ALL: "Hurray,Here is your quiz.",
  UPDATED: "Hurray! Your question has been successfully updated",
  START: "Hurray , The quiz has started",
  CATEGORY: "HURRAY , new Category created",
  CATEGORY_INFO:"Hurray ! ALL Category Information fetched",
  FETCH_PLAYED:"Here is your played quizzes"
};

export const score = {
  CREATED: "Hurray! new score has been added successfully",
  CREATED_DEC: "This question has been created with the some scenario so adding some description.",
  FETCH_ALL: "Hurray,Here is your all ques.",
  UPDATED: "Hurray! Your question has been successfully updated",
  FETCH: "Hurray, here is your question",
  SUBMIT_ANSWER: "Your answer has been submitted",
  TIMED_OUT:"Your time limit has exceeded , Here is your answer"
};

export const wallet = {
  BALANCE: "Hurray! IKC Balance Fetched",
  TRANSACTION: "Hurray! Transactions Details Fetched",
  BUYHINT: "Buy Hint API Hit"
};