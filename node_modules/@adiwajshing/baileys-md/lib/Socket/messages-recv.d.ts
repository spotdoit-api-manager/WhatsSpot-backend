...
import { SocketConfig, ParticipantAction, Chat, GroupMetadata, Contact } from "../Types";
...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    resyncAppState: (collections: import("../Types").WAPatchName[], fromScratch?: boolean) => Promise<import("../Types").AppStateChunk>;
